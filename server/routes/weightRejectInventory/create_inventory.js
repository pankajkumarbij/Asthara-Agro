...
//DEfine route to create weight_reject inventory
router.post('/create_weight_reject_inventory',(req,res)=>{
    var newWeightRejectInventory = new WeightRejectInventory({
