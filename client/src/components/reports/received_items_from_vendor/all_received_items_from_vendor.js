                        ...
                        allReceivedItems.map((item)=>{
                            ...
                            return (
                                <DataTable.Row>
                                    ...
                                    <DataTable.Cell>
                                        {Platform.OS=='android' ?
                                            <Button mode="contained" style={{width: '100%'}} icon={() => <FontAwesomeIcon icon={ faEye } />} onPress={() => {navigation.navigate('View_Received_Order_From_Buyer', {id: item._id})}}></Button>
                                            :
