                            ...
                            allPickupAssignmentConfirm.map((pickupAssignmentConfirm)=>{
                                ...
                                return (
                                    <DataTable.Row>
                                        ...
                                        <DataTable.Cell>
                                            {Platform.OS=='android' ?
                                                <Button mode="contained" icon={() => <FontAwesomeIcon icon={ faEye } />} onPress={() => {navigation.navigate('View_Pickup_Assignment_Confirm_Buyer', {pickupConfirmId: pickupAssignmentConfirm._id})}}>Check</Button>
                                                :
                            ...
                            allPickupAssignmentConfirm.map((pickupAssignmentConfirm)=>{
                                ...
                                return (
                                    <DataTable.Row>
                                        ...
                                        <DataTable.Cell>
                                            {Platform.OS=='android' ?
                                                <Button mode="contained" icon={() => <FontAwesomeIcon icon={ faEye } />} onPress={() => {navigation.navigate('Edit_Pickup_Assignment_Confirm_Buyer', {pickupConfirmId: pickupAssignmentConfirm._id})}}></Button>
                                                :
