...
import { delivery_by_id } from '../../services/delivery';
...
export default function ViewDispatchForDelivery(props,{ route, navigation }) {
        ...
        <ScrollView>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                <Card style={styles.card} >
                    <Card.Title title="View Dispatch For Delivery"/>
                    <Card.Content>
                    <Menu
