...
import { all_weight_reject_inventory } from '../../services/weight_reject_inventory';
...
export default function AllWightRejectInventory({navigation }) {
        ...
        <ScrollView>
            <View style={styles.view}>
                <DataTable style={styles.datatable}>
                    <Title style={styles.title} >Weight Reject Inventory</Title>
                    <Searchbar
